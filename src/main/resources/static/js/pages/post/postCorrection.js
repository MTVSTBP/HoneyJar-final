...
//             placeNameField.value = selectedPlace.place_name.replace(/^,/, '') || selectedPlace.road_address_name.replace(/^,/, '');
...
//             placeXField.value = selectedPlace.x;
//             placeYField.value = selectedPlace.y;
//             placeRoadAddressNameField.value = selectedPlace.road_address_name.replace(/^,/, '');
//             localStorage.removeItem('selectedPlace');
//         }
//
//         updateImagePreview();
...
//             placeIdField.value = postFormState.placeId;
//             localStorage.removeItem('postFormState');
//             postIdField.value = postFormState.postId;
//         }
//
//         const selectedPlace = JSON.parse(localStorage.getItem('selectedPlace'));
//         if (selectedPlace) {
